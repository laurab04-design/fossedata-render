# ===== Cleaned FosseData Script =====
# This is the deduplicated, cleaned version
...
async def main_processing_loop(show_list: list, context):
...
async def full_run():
    async with async_playwright() as pw:
        ...
        results = await main_processing_loop(show_list, context)
        clashes = detect_clashes(results)
        overnights = detect_overnight_pairs(results, travel_cache)
        save_results(results, clashes, overnights, travel_cache, processed_shows)
        upload_to_google_drive()
...
if __name__ == "__main__":
    ...
    print(f"Processed {len(final)} shows.")# ===== Cleaned FosseData Script (In Progress) =====
# This is the deduplicated, cleaned version up to the eligibility logic section.
